...
public class PayFastService {
    ...
    private static final String MERCHANT_ID = "10041759";
    private static final String MERCHANT_KEY = "ac6t0v9kw8raz";
    ...
    private static final String NOTIFY_URL = "https://71cedc67c9e1.ngrok-free.app/api/payments/payfast/notify";
